...
public class BlueSuperchargedGravityGunRecipe extends CustomRecipe {
    private static final String BRUSH_ID = "paintball:blue_paintbrush";

    public BlueSuperchargedGravityGunRecipe(ResourceLocation id, CraftingBookCategory category) {
        super(id, category);
    }
    ...
    public ItemStack assemble(CraftingContainer inv, RegistryAccess registryAccess) {
        return new ItemStack(ModItems.BLUE_SUPERCHARGED_GRAVITY_GUN.get());
    }
    ...
    @Override
    public RecipeSerializer<?> getSerializer() { return ModRecipes.BLUE_SUPERCHARGED_GRAVITY_GUN_RECIPE.get(); }
}