...
public class GreenSuperchargedGravityGunRecipe extends CustomRecipe {
    private static final String BRUSH_ID = "paintball:green_paintbrush";

    public GreenSuperchargedGravityGunRecipe(ResourceLocation id, CraftingBookCategory category) {
        super(id, category);
    }
    ...
    public ItemStack assemble(CraftingContainer inv, RegistryAccess registryAccess) {
        return new ItemStack(ModItems.GREEN_SUPERCHARGED_GRAVITY_GUN.get());
    }
    ...
    @Override
    public RecipeSerializer<?> getSerializer() { return ModRecipes.GREEN_SUPERCHARGED_GRAVITY_GUN_RECIPE.get(); }
}