...
public class OrangeSuperchargedGravityGunRecipe extends CustomRecipe {
    private static final String BRUSH_ID = "paintball:orange_paintbrush";

    public OrangeSuperchargedGravityGunRecipe(ResourceLocation id, CraftingBookCategory category) {
        super(id, category);
    }
    ...
    public ItemStack assemble(CraftingContainer inv, RegistryAccess registryAccess) {
        return new ItemStack(ModItems.ORANGE_SUPERCHARGED_GRAVITY_GUN.get());
    }
    ...
    @Override
    public RecipeSerializer<?> getSerializer() { return ModRecipes.ORANGE_SUPERCHARGED_GRAVITY_GUN_RECIPE.get(); }
}