...
public class ModelGravityGunDetailed extends Model {
    ...
    public void renderToBuffer(PoseStack matrixStack, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        corefrontbottom.render(matrixStack, buffer, packedLight, packedOverlay);
        stock1.render(matrixStack, buffer, packedLight, packedOverlay);
        corebackleft.render(matrixStack, buffer, packedLight, packedOverlay);
        stock4.render(matrixStack, buffer, packedLight, packedOverlay);
        stock3.render(matrixStack, buffer, packedLight, packedOverlay);
        corefrontmain.render(matrixStack, buffer, packedLight, packedOverlay);
        stock2.render(matrixStack, buffer, packedLight, packedOverlay);
        coreleft.render(matrixStack, buffer, packedLight, packedOverlay);
        ...
        bodyrightback.render(matrixStack, buffer, packedLight, packedOverlay);
        gaugethingyL.render(matrixStack, buffer, packedLight, packedOverlay);
        frontright.render(matrixStack, buffer, packedLight, packedOverlay);
        coreright.render(matrixStack, buffer, packedLight, packedOverlay);
        corebottom.render(matrixStack, buffer, packedLight, packedOverlay);
        frontbottom.render(matrixStack, buffer, packedLight, packedOverlay);
        bodyleftback.render(matrixStack, buffer, packedLight, packedOverlay);
        corebackmain.render(matrixStack, buffer, packedLight, packedOverlay);
        coretop.render(matrixStack, buffer, packedLight, packedOverlay);
        bodyrighttop.render(matrixStack, buffer, packedLight, packedOverlay);
        Lstick2.render(matrixStack, buffer, packedLight, packedOverlay);
        Lstick3.render(matrixStack, buffer, packedLight, packedOverlay);
        Lstick1.render(matrixStack, buffer, packedLight, packedOverlay);
        corebackright.render(matrixStack, buffer, packedLight, packedOverlay);
        bodyleftmain.render(matrixStack, buffer, packedLight, packedOverlay);
        frontmain.render(matrixStack, buffer, packedLight, packedOverlay);
        bodyrightmain.render(matrixStack, buffer, packedLight, packedOverlay);
        bodyrightbottom.render(matrixStack, buffer, packedLight, packedOverlay);
        bodyrightfront.render(matrixStack, buffer, packedLight, packedOverlay);
        bodylefttop.render(matrixStack, buffer, packedLight, packedOverlay);
        bodyleftfront.render(matrixStack, buffer, packedLight, packedOverlay);
        corefrontright.render(matrixStack, buffer, packedLight, packedOverlay);
        bodyleftbottom.render(matrixStack, buffer, packedLight, packedOverlay);
        sidehandleL.render(matrixStack, buffer, packedLight, packedOverlay);
        corefronttop.render(matrixStack, buffer, packedLight, packedOverlay);
        corefrontleft.render(matrixStack, buffer, packedLight, packedOverlay);
        fronttop.render(matrixStack, buffer, packedLight, packedOverlay);
        corebackbottom.render(matrixStack, buffer, packedLight, packedOverlay);
        Rstick1.render(matrixStack, buffer, packedLight, packedOverlay);
        Rstick2.render(matrixStack, buffer, packedLight, packedOverlay);
        Rstick3.render(matrixStack, buffer, packedLight, packedOverlay);
        corebacktop.render(matrixStack, buffer, packedLight, packedOverlay);
        coremain.render(matrixStack, buffer, packedLight, packedOverlay);
    ...
    public void setClawOpen(float prog) {
        float close = 60.0F;
        this.clawtopthick.zRot = (float) Math.toRadians(-close + (close - 20.0F) * prog);
        this.clawleftthick.xRot = (float) Math.toRadians(close - (close - 20.0F) * prog);
        this.clawrightthick.xRot = (float) Math.toRadians(close - (close - 20.0F) * prog);
    }
